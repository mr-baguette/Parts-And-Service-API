...
namespace PnSAPI.Core
{
    public abstract class ModBase
    {
        ...
        public void LogDebug(string message) => BepInExPlugin.BepInExAdapter.LogDebug($"[{Name}] {message}");
        ...
        public void LogInfo(string message) => BepInExPlugin.BepInExAdapter.LogInfo($"[{Name}] {message}");
        ...
        public void LogWarning(string message) => BepInExPlugin.BepInExAdapter.LogWarning($"[{Name}] {message}");
        /// <summary>Logs to the BepInEx terminal under the APIs name. Use this if something critical went wrong.</summary>
        public void LogError(string message) => BepInExPlugin.BepInExAdapter.LogError($"[{Name}] {message}");
    }
}
